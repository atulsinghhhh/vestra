      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-black/80 backdrop-blur-md border-b border-white/10" : "bg-transparent"}`}>
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Link href="/" className="text-2xl font-bold text-white">Vestra</Link>
          </div>
          <div className="flex items-center gap-4">
            <Link href="/wardrobe" className="text-sm font-medium text-gray-300 hover:text-white transition-colors">
              Wardrobe
            </Link>
            <Link href="/onboarding" className="text-sm font-medium text-gray-300 hover:text-white transition-colors">
              Onboarding
            </Link>
            <Link href="/packing" className="text-sm font-medium text-gray-300 hover:text-white transition-colors">
              Packing
            </Link>
            <Link href="/occasions" className="text-sm font-medium text-gray-300 hover:text-white transition-colors">
              Occasions
            </Link>
          </div>
