...
function LoginForm() {
  ...
  return (
    <div className="relative z-20 flex flex-col gap-6 text-gray-200 font-sans">
      {/* Header */}
      <div className="text-center space-y-2 mb-2">
        <h1 className="text-3xl font-light tracking-widest text-white">VESTRA</h1>
        <p className="text-sm text-gray-400 font-light tracking-wide uppercase">Welcome Back</p>
      </div>
      ...
      <div className="text-center">
        <p className="text-xs text-gray-500">
          ...
          <Link href="/signup" className="text-white hover:text-gray-300 transition-colors underline decoration-white/30 underline-offset-4">
            Sign up
          </Link>
        </p>
      </div>
...
export default function LoginPage() {
  return (
    <div className="min-h-screen w-full bg-[#050505] flex items-center justify-center relative overflow-hidden text-gray-200 font-sans selection:bg-white/10">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[600px] h-[600px] rounded-full bg-purple-900/10 blur-[120px] animate-pulse-slow pointer-events-none" />
