...
// Assuming you have Lucide icons, or I'll use SVGs if not.
// Standard import for Next.js projects often includes lucide-react. I'll check/try using it or standard SVGs.
// To be safe I'll use standard SVGs for icons to avoid import errors if lucide isn't installed.
    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-purple-500/30">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-black/80 backdrop-blur-md border-b border-white/10" : "bg-transparent"}`}>
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-xl tracking-tight">Vestra</span>
          </div>
          ...
          <div className="flex items-center gap-4">
             ...
             <Link href="/auth/signup" className="px-5 py-2.5 rounded-full bg-white text-black text-sm font-semibold hover:bg-gray-100 transition-colors">
               Get Started
             </Link>
          </div>
        </div>
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden px-6">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/dashboard" className="w-full sm:w-auto px-8 py-4 rounded-full bg-white text-black font-semibold hover:bg-gray-100 transition-all transform hover:scale-105">
              Start Styling Free
            </Link>
            <Link href="#demo" className="w-full sm:w-auto px-8 py-4 rounded-full bg-white/5 border border-white/10 text-white font-semibold hover:bg-white/10 transition-all backdrop-blur-sm">
              Watch Demo
            </Link>
          </div>
        </div>
      ...
      <section className="py-10 border-y border-white/5 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
           <div>
              ...
              <p className="text-sm text-gray-500 uppercase tracking-wider">Outfits Generated</p>
           </div>
           <div>
              <p className="text-3xl font-bold text-white">50k+</p>
              <p className="text-sm text-gray-500 uppercase tracking-wider">Items Digitized</p>
           </div>
           <div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-5xl mx-auto text-center relative">
          <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-indigo-500/20 blur-[100px] -z-10 rounded-full" />
          
          <h2 className="text-4xl md:text-6xl font-bold mb-8">Ready to upgrade your style?</h2>
          <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">Join thousands of users who have streamlined their morning routine with Vestra.</p>
          
          <Link href="/auth/signup" className="inline-flex items-center gap-2 px-10 py-5 rounded-full bg-white text-black font-bold text-lg hover:bg-gray-200 transition-colors shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)]">
